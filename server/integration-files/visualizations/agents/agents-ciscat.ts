/*
 * Portal9 app - Module for Agents/CIS-CAT visualizations
...
export default [
  {
    _id: 'Portal9-app-Agents-CISCAT-alerts-summary',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Portal9-app-Agents-CISCAT-last-scan-not-checked',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Portal9-app-Agents-CISCAT-last-scan-score',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Portal9-app-Agents-CISCAT-last-scan-pass',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Portal9-app-Agents-CISCAT-last-scan-fail',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Portal9-app-Agents-CISCAT-last-scan-timestamp',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Portal9-app-Agents-CISCAT-last-scan-error',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Portal9-app-Agents-CISCAT-last-scan-benchmark',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Portal9-app-Agents-CISCAT-last-scan-unknown',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Portal9-app-Agents-CISCAT-top-5-groups',
    _type: 'visualization',
    _source: {
      title: 'Top 5 groups',
      visState: JSON.stringify({
  ...
  {
    _id: 'Portal9-app-Agents-CISCAT-scan-result-evolution',
    _type: 'visualization',
    _source: {
