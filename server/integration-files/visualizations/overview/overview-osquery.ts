/*
 * Portal9 app - Module for Overview/Osquery visualizations
...
export default [
  {
    _id: 'Portal9-App-Overview-Osquery-Alerts-over-time',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Portal9-App-Overview-Osquery-Most-common-packs',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Portal9-App-Overview-Osquery-Top-5-rules',
    _type: 'visualization',
    _source: {
      title: 'Top 5 rules',
      visState: JSON.stringify({
  ...
  {
    _id: 'Portal9-App-Overview-Osquery-Top-5-Agents',
    _type: 'visualization',
    _source: {
      title: 'Top 5 Agents',
      visState: JSON.stringify({
  ...
  {
    _id: 'Portal9-App-Overview-Osquery-Agents-reporting',
    _type: 'visualization',
    _source: {
