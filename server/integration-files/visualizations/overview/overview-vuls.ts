        ...
        aggs: [
          {
            ...
            type: 'count',
            schema: 'metric',
            params: { customLabel: 'Critical severity alerts' },
          },
        ],
      }),
      uiStateJSON: '{}',
        ...
        aggs: [
          {
            ...
            type: 'count',
            schema: 'metric',
            params: { customLabel: 'High severity alerts' },
          },
        ],
      }),
      uiStateJSON: '{}',
        ...
        aggs: [
          {
            ...
            type: 'count',
            schema: 'metric',
            params: { customLabel: 'Medium severity alerts' },
          },
        ],
      }),
      uiStateJSON: '{}',
        ...
        aggs: [
          {
            ...
            type: 'count',
            schema: 'metric',
            params: { customLabel: 'Low severity alerts' },
          },
        ],
      }),
      uiStateJSON: '{}',
