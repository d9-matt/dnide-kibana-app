...
describe('Portal9 API - /elastic/samplealerts/{category}', () => {
  ...
  test('[200] Create sample alers of Security category', () => {
    const options = buildAxiosOptions('post', '/elastic/samplealerts/security', {
  ...
  test('[200] Create sample alers of Audit and Policy monitoring category', () => {
    const options = buildAxiosOptions('post', '/elastic/samplealerts/auditing-policy-monitoring', {
  ...
  test('[200] Create sample alers of Theard detection category', () => {
    const options = buildAxiosOptions('post', '/elastic/samplealerts/threat-detection', {
  ...
  test('[200] Delete sample alers of Security category', () => {
    const options = buildAxiosOptions('delete', '/elastic/samplealerts/security', {
  ...
  test('[200] Delete sample alers of Audit and Policy monitoring category', () => {
    const options = buildAxiosOptions('delete', '/elastic/samplealerts/auditing-policy-monitoring', {
  ...
  test('[200] Delete sample alers of Theard detection category', () => {
    const options = buildAxiosOptions('delete', '/elastic/samplealerts/threat-detection', {
