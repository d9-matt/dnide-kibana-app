...
import { PORTAL9_SAMPLE_ALERTS_CATEGORY_SECURITY, PORTAL9_SAMPLE_ALERTS_CATEGORY_AUDITING_POLICY_MONITORING, PORTAL9_SAMPLE_ALERTS_CATEGORY_THREAT_DETECTION } from '../../common/constants';
...
export function Portal9ElasticRoutes(router: IRouter) {
  ...
  const schemaSampleAlertsCategories = schema.oneOf([
    PORTAL9_SAMPLE_ALERTS_CATEGORY_SECURITY,
    PORTAL9_SAMPLE_ALERTS_CATEGORY_AUDITING_POLICY_MONITORING,
    PORTAL9_SAMPLE_ALERTS_CATEGORY_THREAT_DETECTION
