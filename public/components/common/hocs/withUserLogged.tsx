/*
 * Portal9 app - React HOC to manage if the user is logged in
...
export const withUserLogged = (WrappedComponent) => (props) => {
    ...
    return withUserLogged ? <WrappedComponent {...props}/> : (
      <div className="withUserLogged">
        <img src={getHttp().basePath.prepend('/plugins/portal9/assets/Portal9_icon_larger.png')} className="withUserLogged-logo" alt=""></img>
        <EuiSpacer size="s" />
