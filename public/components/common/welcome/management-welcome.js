/*
 * Portal9 app - React component for building the management welcome screen.
 *
                ...
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your Portal9 cluster rules."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your Portal9 cluster decoders."
                    />
                  </EuiFlexItem>
                </EuiFlexGroup>
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your Portal9 cluster CDB lists."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem>
                    <EuiCard
                ...
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your Portal9 cluster configuration."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem />
                </EuiFlexGroup>
                ...
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your Portal9 cluster status."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Visualize your Portal9 cluster."
                    />
                  </EuiFlexItem>
                </EuiFlexGroup>
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Logs from your Portal9 cluster."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Check your stored Portal9 reports."
                    />
                  </EuiFlexItem>
                </EuiFlexGroup>
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Information about the Portal9 environment"
                    />
                  </EuiFlexItem>
                  <EuiFlexItem>
                  </EuiFlexItem>
