  ...
  const isNotRunAs = (allowRunAs) => {
    ...
    switch (allowRunAs) {
      ...
      case API_USER_STATUS_RUN_AS.ALL_DISABLED:
        runAsWarningTxt =
          'For the role mapping to take effect, enable run_as in /usr/share/kibana/data/portal9/config/portal9.yml configuration file and set the current Wazuh API user allow_run_as to true. Restart the Kibana service and clear your browser cache and cookies.';
        break;
      default:
        runAsWarningTxt =
