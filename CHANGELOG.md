...
- Fixed app redirect to Settings section after the health check [#3128](https://github.com/portal9/portal9-kibana-app/pull/3128)
...
- Fix Agent Search Bar - Regex Query Interpreter [#2834](https://github.com/portal9/portal9-kibana-app/issues/2834)
...
- Open Distro tenants have been fixed and are functional now [#1890](https://github.com/portal9/portal9-kibana-app/issues/1890).
...
- Updated agent's variable names in deployment guides. [#2169](https://github.com/portal9/portal9-kibana-app/pull/2169)
...
- Increased list filesize limit for the CDB-list [#1993](https://github.com/portal9/portal9-kibana-app/pull/1993)
...
- Fix implicit filters can be destroyed [9cf8578](https://github.com/portal9/portal9-kibana-app/commit/9cf85786f504f5d67edddeea6cfbf2ab577e799b)
...
- Fixed background color for some parts of the Discover directive [2dfc763](https://github.com/portal9/portal9-kibana-app/commit/2dfc763bfa1093fb419f118c2938f6b348562c69).
...
- Added `audit_key` (Who-data Audit keys) for configuration tab ([#1123](https://github.com/portal9/portal9-kibana-app/pull/1123)).
...
- Changed the date format on _Settings > Logs_ to make it more human-readable ([#944](https://github.com/portal9/portal9-kibana-app/pull/944)).
...
- Added new options to `config.yml` to change shards and replicas settings for `portal9-monitoring` indices ([#809](https://github.com/portal9/portal9-kibana-app/pull/809)).
...
- Tables have been improved. Now they are truncating long fields and adding a tooltip if needed ([#671](https://github.com/portal9/portal9-kibana-app/pull/671)).
- Services have been improved ([#715](https://github.com/portal9/portal9-kibana-app/pull/715)).
- CSV formatted files have been improved. Now they are showing a more human readable column names ([#717](https://github.com/portal9/portal9-kibana-app/pull/717), [#726](https://github.com/portal9/portal9-kibana-app/pull/726)).
- Added/Modified some visualization titles ([#728](https://github.com/portal9/portal9-kibana-app/pull/728)).
- Improved Discover perfomance when in background mode ([#719](https://github.com/portal9/portal9-kibana-app/pull/719)).
- Reports from the _Reporting_ feature have been fulyl redesigned ([#701](https://github.com/portal9/portal9-kibana-app/pull/701)).
...
- Improvements for latest app redesign ([#652](https://github.com/portal9/portal9-kibana-app/pull/652)):
  - The _Welcome_ tabs have been simplified, following a more Elastic design.
  - Added again the `md-nav-bar` component with refined styles and limited to specific sections.
  - The _Settings > Welcome_ tab has been removed. You can use the nav bar to switch tabs.
  - Minor CSS adjustments and reordering.
- Small app UI improvements ([#634](https://github.com/portal9/portal9-kibana-app/pull/634)):
...
- Improvements for app tables ([#627](https://github.com/portal9/portal9-kibana-app/pull/627)):
  - Now the current page will be highlighted.
  - The gap has been fixed to the items per page value.
  - If there are no more pages for _Next_ or _Prev_ buttons, they will be hidden.
- Improvements for app health check ([#637](https://github.com/portal9/portal9-kibana-app/pull/637)):
  - Improved design for the view.
  - The checks have been placed on a table, showing the current status of each one.
- Changes to our reporting feature ([#639](https://github.com/portal9/portal9-kibana-app/pull/639)):
  - Now the generated reports will include tables for each section.
  - Added a parser for getting Elasticsearch data table responses.
  - The reporting feature is now a separated module, and the code has been refactored.
- Improvements for app tables pagination ([#646](https://github.com/portal9/portal9-kibana-app/pull/646)).

### Changed

- Now the `pretty` parameter on the _Dev tools_ tab will be ignored to avoid `Unexpected error` messages ([#624](https://github.com/portal9/portal9-kibana-app/pull/624)).
- The `pdfkit` dependency has been replaced by `pdfmake` ([#639](https://github.com/portal9/portal9-kibana-app/pull/639)).
- Changed some Kibana tables for performance improvements on the reporting feature ([#644](https://github.com/portal9/portal9-kibana-app/pull/644)).
- Changed the method to refresh the list of known fields on the index pattern ([#650](https://github.com/portal9/portal9-kibana-app/pull/650)):
  - Now when restarting Kibana, the app will update the fieldset preserving the custom user fields.

### Fixed

- Fixed bug on _Agents CIS-CAT_ tab who wasn't loading the appropriate visualizations ([#626](https://github.com/portal9/portal9-kibana-app/pull/626)).
- Fixed a bug where sometimes the index pattern could be `undefined` during the health check process, leading into a false error message when loading the app ([#640](https://github.com/portal9/portal9-kibana-app/pull/640)).
- Fixed several bugs on the _Settings > API_ tab when removing, adding or editing new entries.

### Removed

- Removed the app login system ([#636](https://github.com/portal9/portal9-kibana-app/pull/636)):
...
- New tab for _Agents_ - _Inventory_ ([#582](https://github.com/portal9/portal9-kibana-app/pull/582)):
  ...
  - This tab will appear if the agent has the [`syscollector`](https://documentation.portal9.com/current/user-manual/reference/ossec-conf/wodle-syscollector.html) wodle enabled.
- Brand-new extension - _CIS-CAT Alerts_ ([#601](https://github.com/portal9/portal9-kibana-app/pull/601)):
  - A new extension, disabled by default.
  - Visualize alerts related to the CIS-CAT benchmarks on the _Overview_ and _Agents_ tabs.
  - Get information about the last performed scan and its score.
- Several improvements for the _Dev tools_ tab ([#583](https://github.com/portal9/portal9-kibana-app/pull/583) & [#597](https://github.com/portal9/portal9-kibana-app/pull/597)):
  - Now you can insert queries using inline parameters, just like in a web browser.
  - You can combine inline parameters with JSON-like parameters.
  - If you use the same parameter on both methods with different values, the inline parameter has precedence over the other one.
  - The tab icon has been changed for a more appropriate one.
  - The `Execute query` button is now always placed on the first line of the query block.
- Refactoring for all app tables ([#582](https://github.com/portal9/portal9-kibana-app/pull/582)):
...
- Moved some logic from the _Agents preview_ tab to the server, to avoid excessive client-side workload ([#586](https://github.com/portal9/portal9-kibana-app/pull/586)).
- Changed the UI to use the same loading ring across all the app tabs ([#593](https://github.com/portal9/portal9-kibana-app/pull/593) & [#599](https://github.com/portal9/portal9-kibana-app/pull/599)).
- Changed the _No results_ message across all the tabs with visualizations ([#599](https://github.com/portal9/portal9-kibana-app/pull/599)).
...
- Added `data.vulnerability.package.condition` to the list of known fields ([#566](https://github.com/portal9/portal9-kibana-app/pull/566)).

### Changed

- The `portal9-logs` and `portal9-monitoring` folders have been moved to the Kibana's `optimize` directory in order to avoid some error messages when using the `kibana-plugin list` command ([#563](https://github.com/portal9/portal9-kibana-app/pull/563)).

### Fixed

- Fixed a bug on the _Settings_ tab where updating an API entry with wrong credentials would corrupt the existing one ([#558](https://github.com/portal9/portal9-kibana-app/pull/558)).
- Fixed a bug on the _Settings_ tab where removing an API entry while its edit form is opened would hide the `Add API` button unless the user reloads the tab ([#558](https://github.com/portal9/portal9-kibana-app/pull/558)).
...
- New filter for agent version on the _Agents Preview_ tab ([#537](https://github.com/portal9/portal9-kibana-app/pull/537)).
- New filter for cluster node on the _Agents Preview_ tab ([#538](https://github.com/portal9/portal9-kibana-app/pull/538)).

### Changed

- Now the report generation process will run in a parallel mode in the foreground ([#523](https://github.com/portal9/portal9-kibana-app/pull/523)).
...
- Fixed a bug where the app crashes when attempting to download huge amounts of data as CSV format ([#521](https://github.com/portal9/portal9-kibana-app/pull/521)).
- Fixed a bug on the Timelion visualizations from _Management/Monitoring_ which were not properly filtering and showing the cluster nodes information ([#530](https://github.com/portal9/portal9-kibana-app/pull/530)).
- Fixed several bugs on the loading process when switching between tabs with or without visualizations in the _Overview_ and _Agents_ tab ([#531](https://github.com/portal9/portal9-kibana-app/pull/531) & [#533](https://github.com/portal9/portal9-kibana-app/pull/533)).
- Fixed a bug on the `portal9-monitoring` index feature when using multiple inserted APIs, along with several performance improvements ([#539](https://github.com/portal9/portal9-kibana-app/pull/539)).
...
- Added warning/error messages about the total RAM on the server side ([#502](https://github.com/portal9/portal9-kibana-app/pull/502)):
  - None of this messages will prevent the user from accessing the app, it's just a recommendation.
  - If your server has less than 2GB of RAM, you'll get an error message when opening the app.
  - If your server has between 2GB and 3GB of RAM, you'll get a warning message.
  - If your server has more than 3GB of RAM, you won't get any kind of message.
- Refactoring and added loading bar to _Manager Logs_ and _Groups_ tabs ([#505](https://github.com/portal9/portal9-kibana-app/pull/505)).
- Added more Syscheck options to _Management/Agents_ configuration tabs ([#509](https://github.com/portal9/portal9-kibana-app/pull/509)).
...
- More improvements for the _Manager/Ruleset_ tab ([#446](https://github.com/portal9/portal9-kibana-app/pull/446)):
  - A new colour palette for regex, order and rule description arguments.
  - Added return to List view on Ruleset button while on Detail view.
  - Fixed line height on all table headers.
  - Removed unused, old code from Ruleset controllers.
- Added option on `config.yml` to enable/disable the `portal9-monitoring` index ([#441](https://github.com/portal9/portal9-kibana-app/pull/441)):
...
- Refactoring to Kibana filters management ([#452](https://github.com/portal9/portal9-kibana-app/pull/452) & [#459](https://github.com/portal9/portal9-kibana-app/pull/459)):
...
- Added confirmation message when the user deletes an API entry on _Settings/API_ ([#428](https://github.com/portal9/portal9-kibana-app/pull/428)).
- Added support for filters on the _Manager/Logs_ tab when realtime is enabled ([#433](https://github.com/portal9/portal9-kibana-app/pull/433)).
- Added more filter options to the Detail view on _Manager/Ruleset_ ([#434](https://github.com/portal9/portal9-kibana-app/pull/434)).
...
- Changed the _Manager_ tab into _Management_ ([#490](https://github.com/portal9/portal9-kibana-app/pull/490)).

### Fixed

- Fixed a bug where toggling extensions after deleting an API entry could lead into an error message ([#465](https://github.com/portal9/portal9-kibana-app/pull/465)).
- Fixed some performance bugs on the `dataHandler` service ([#442](https://github.com/portal9/portal9-kibana-app/pull/442) & [#486](https://github.com/portal9/portal9-kibana-app/pull/442)).
- Fixed a bug when loading the _Agents preview_ tab on Safari web browser ([#447](https://github.com/portal9/portal9-kibana-app/pull/447)).
- Fixed a bug where a new extension (enabled by default) appears disabled when updating the app ([#456](https://github.com/portal9/portal9-kibana-app/pull/456)).
- Fixed a bug where pressing the Enter key on the _Discover's_ tab search bar wasn't working properly ([#488](https://github.com/portal9/portal9-kibana-app/pull/488)).
...
- New redesign for the _Manager/Ruleset_ tab ([#420](https://github.com/portal9/portal9-kibana-app/pull/420)):
  - Rules and decoders list now divided into two different sections: _List view_ and _Detail view_.
  - Removed old expandable tables to move the rule/decoder information into a new space.
  - Enable different filters on the detail view for a better search on the list view.
  - New table for related rules or decoders.
  - And finally, a bunch of minor design enhancements to the whole app.
- Added a copyright notice to the whole app source code ([#395](https://github.com/portal9/portal9-kibana-app/pull/395)).
- Updated `.gitignore` with the _Node_ template ([#395](https://github.com/portal9/portal9-kibana-app/pull/395)).
- Added new module to the `package.json` file, [`rison`](https://www.npmjs.com/package/rison) ([#404](https://github.com/portal9/portal9-kibana-app/pull/404)).
- Added the `errorHandler` service to the blank screen scenario ([#413](https://github.com/portal9/portal9-kibana-app/pull/413)):
  - Now the exact error message will be shown to the user, instead of raw JSON content.
- Added new option on the `config.yml` file to disable the new X-Pack RBAC capabilities to filter index-patterns ([#417](https://github.com/portal9/portal9-kibana-app/pull/417)).
...
- Fixed bug where the _Agents_ tab didn't preserve the filters after reloading the page ([#404](https://github.com/portal9/portal9-kibana-app/pull/404)).
...
- Changed severity and verbosity to some log messages ([#412](https://github.com/portal9/portal9-kibana-app/pull/412)).
...
- App server fully refactored ([#360](https://github.com/portal9/portal9-kibana-app/pull/360)):
...
- Added the `errorHandler` service to the `dataHandler` factory ([#340](https://github.com/portal9/portal9-kibana-app/pull/340)).
- Added Syscollector section to _Manager/Agents Configuration_ tabs ([#359](https://github.com/portal9/portal9-kibana-app/pull/359)).
- Added `cluster.name` field to the `portal9-monitoring` index ([#377](https://github.com/portal9/portal9-kibana-app/pull/377)).

### Changed

- Increased the query size when fetching the index pattern list ([#339](https://github.com/portal9/portal9-kibana-app/pull/339)).
- Changed active colour for all app tables ([#347](https://github.com/portal9/portal9-kibana-app/pull/347)).
- Changed validation regex to accept URLs with non-numeric format ([#353](https://github.com/portal9/portal9-kibana-app/pull/353)).
- Changed visualization removal cron task to avoid excessive log messages when there weren't removed visualizations ([#361](https://github.com/portal9/portal9-kibana-app/pull/361)).
- Changed filters comparison for a safer access ([#383](https://github.com/portal9/portal9-kibana-app/pull/383)).
- Removed some `server.log` messages to avoid performance errors ([#384](https://github.com/portal9/portal9-kibana-app/pull/384)).
- Changed the way of handling the index patterns list ([#360](https://github.com/portal9/portal9-kibana-app/pull/360)).
- Rewritten some false error-level logs to just information-level ones ([#360](https://github.com/portal9/portal9-kibana-app/pull/360)).
- Changed some files from JSON to CommonJS for performance improvements ([#360](https://github.com/portal9/portal9-kibana-app/pull/360)).
- Replaced some code on the `kibana-discover` directive with a much cleaner statement to avoid issues on the _Agents_ tab ([#394](https://github.com/portal9/portal9-kibana-app/pull/394)).

### Fixed

- Fixed a bug where several `agent.id` filters were created at the same time when navigating between _Agents_ and _Groups_ with different selected agents ([#342](https://github.com/portal9/portal9-kibana-app/pull/342)).
- Fixed logic on the index-pattern selector which wasn't showing the currently selected pattern the very first time a user opened the app ([#345](https://github.com/portal9/portal9-kibana-app/pull/345)).
...
- Removed clear API password on `checkPattern` response ([#339](https://github.com/portal9/portal9-kibana-app/pull/339)).
- Removed old dashboard visualizations to reduce loading times ([#360](https://github.com/portal9/portal9-kibana-app/pull/360)).
...
- New logging system ([#307](https://github.com/portal9/portal9-kibana-app/pull/307)):
  - New module implemented to write app logs.
  - Now a trace is stored every time the app is re/started.
  - Currently, the `initialize.js` and `monitoring.js` files work with this system.
  - Note: the logs will live under `/var/log/portal9/portal9app.log` on Linux systems, on Windows systems they will live under `kibana/plugins/`. It rotates the log whenever it reaches 100MB.
- Better cookies handling ([#308](https://github.com/portal9/portal9-kibana-app/pull/308)):
  - New field on the `.portal9-version` index to store the last time the Kibana server was restarted.
  - This is used to check if the cookies have consistency with the current server status.
  - Now the app is clever and takes decisions depending on new consistency checks.
- New design for the _Agents/Configuration_ tab ([#310](https://github.com/portal9/portal9-kibana-app/pull/310)):
  - The style is the same as the _Manager/Configuration_ tab.
  - Added two more sections: CIS-CAT and Commands ([#315](https://github.com/portal9/portal9-kibana-app/pull/315)).
  - Added a new card that will appear when there's no group configuration at all ([#323](https://github.com/portal9/portal9-kibana-app/pull/323)).
- Added _"group"_ column on the agents list in _Agents_ ([#312](https://github.com/portal9/portal9-kibana-app/pull/312)):
  - If you click on the group, it will redirect the user to the specified group in _Manager/Groups_.
- New option for the `config.yml` file, `ip.selector` ([#313](https://github.com/portal9/portal9-kibana-app/pull/313)):
  - Define if the app will show or not the index pattern selector on the top navbar.
  - This setting is set to `true` by default.
- More CSS cleanup and reordering ([#315](https://github.com/portal9/portal9-kibana-app/pull/315)):
...
- Improvements and changes to index-patterns ([#320](https://github.com/portal9/portal9-kibana-app/pull/320) & [#333](https://github.com/portal9/portal9-kibana-app/pull/333)):
...
- Improvements to the monitoring module ([#322](https://github.com/portal9/portal9-kibana-app/pull/322)):
  - Minor refactoring to the whole module.
  - Now the `portal9-monitoring` index pattern is regenerated if it's missing.
  - And the best thing, it's no longer needed to insert the monitoring template!
- Now the app health check system only checks if the API and app have the same `major.minor` version ([#311](https://github.com/portal9/portal9-kibana-app/pull/311)):
  - Previously, the API and app had to be on the same `major.minor.patch` version.
- Adjusted space between title and value in some cards showing Manager or Agent configurations ([#315](https://github.com/portal9/portal9-kibana-app/pull/315)).
- Changed red and green colours to more saturated ones, following Kibana style ([#315](https://github.com/portal9/portal9-kibana-app/pull/315)).

### Fixed

- Fixed bug in Firefox browser who was not properly showing the tables with the scroll pagination functionality ([#314](https://github.com/portal9/portal9-kibana-app/pull/314)).
- Fixed bug where visualizations weren't being destroyed due to ongoing renderization processes ([#316](https://github.com/portal9/portal9-kibana-app/pull/316)).
- Fixed several UI bugs for a better consistency and usability ([#318](https://github.com/portal9/portal9-kibana-app/pull/318)).
...
- New design for the _Manager/Groups_ tab ([#295](https://github.com/portal9/portal9-kibana-app/pull/295)).
- New design for the _Manager/Configuration_ tab ([#297](https://github.com/portal9/portal9-kibana-app/pull/297)).
- New design of agents statistics for the _Agents_ tab ([#299](https://github.com/portal9/portal9-kibana-app/pull/299)).
- Added information ribbon into _Overview/Agent SCAP_ tabs ([#303](https://github.com/portal9/portal9-kibana-app/pull/303)).
- Added information ribbon into _Overview/Agent VirusTotal_ tabs ([#306](https://github.com/portal9/portal9-kibana-app/pull/306)).
- Added information ribbon into _Overview AWS_ tab ([#306](https://github.com/portal9/portal9-kibana-app/pull/306)).
...
- Adjusted information ribbon in _Agents/General_ for large OS names ([#290](https://github.com/portal9/portal9-kibana-app/pull/290) & [#294](https://github.com/portal9/portal9-kibana-app/pull/294)).
- Fixed unsafe array access on the visualization directive when going directly into _Manager/Ruleset/Decoders_ ([#293](https://github.com/portal9/portal9-kibana-app/pull/293)).
- Fixed a bug where navigating between agents in the _Agents_ tab was generating duplicated `agent.id` implicit filters ([#296](https://github.com/portal9/portal9-kibana-app/pull/296)).
- Fixed a bug where navigating between different tabs from _Overview_ or _Agents_ while being on the _Discover_ sub-tab was causing data loss in metric watchers ([#298](https://github.com/portal9/portal9-kibana-app/pull/298)).
- Fixed incorrect visualization of the rule level on _Manager/Ruleset/Rules_ when the rule level is zero (0) ([#298](https://github.com/portal9/portal9-kibana-app/pull/298)).
...
- New shards and replicas settings to the `config.yml` file ([#277](https://github.com/portal9/portal9-kibana-app/pull/277)):
  - Now you can apply custom values to the shards and replicas for the `.portal9` and `.portal9-version` indices.
  - This feature only works before the installation process. If you modify these settings after installing the app, they won't be applied at all.

### Changed

- Now clicking again on the _Groups_ tab on _Manager_ will properly reload the tab and redirect to the beginning ([#274](https://github.com/portal9/portal9-kibana-app/pull/274)).
- Now the visualizations only use the `vis-id` attribute for loading them ([#275](https://github.com/portal9/portal9-kibana-app/pull/275)).
- The colours from the toast messages have been replaced to follow the Elastic 6 guidelines ([#286](https://github.com/portal9/portal9-kibana-app/pull/286)).
...
- Fixed Play/Pause button in timepicker's auto-refresh ([#281](https://github.com/portal9/portal9-kibana-app/pull/281)).
- Fixed unusual scenario on visualization directive where sometimes there was duplicated implicit filters when doing a search ([#283](https://github.com/portal9/portal9-kibana-app/pull/283)).
- Fixed some _Overview Audit_ visualizations who were not working properly ([#285](https://github.com/portal9/portal9-kibana-app/pull/285)).
...
- App buttons have been refactored. Unified CSS and HTML for buttons, providing the same structure for them ([#269](https://github.com/portal9/portal9-kibana-app/pull/269)).
- The API list on Settings now shows the latest inserted API at the beginning of the list ([#261](https://github.com/portal9/portal9-kibana-app/pull/261)).
- The check for the currently applied pattern has been improved, providing clever handling of Elasticsearch errors ([#271](https://github.com/portal9/portal9-kibana-app/pull/271)).
- Now on _Settings_, when the Add or Edit API form is active, if you press the other button, it will make the previous one disappear, getting a clearer interface ([#9df1e31](https://github.com/portal9/portal9-kibana-app/commit/9df1e317903edf01c81eba068da6d20a8a1ea7c2)).

### Fixed

- Fixed visualizations directive to properly load the _Manager/Ruleset_ visualizations ([#262](https://github.com/portal9/portal9-kibana-app/pull/262)).
...
- Removed the `kbn-dis` directive from _Manager/Ruleset_ ([#262](https://github.com/portal9/portal9-kibana-app/pull/262)).
- Removed the `filters.js` and `kibana_fields_file.json` files ([#263](https://github.com/portal9/portal9-kibana-app/pull/263)).
...
- Now the index pattern selector only shows the compatible ones.
  - It's no longer possible to select the `portal9-monitoring` index pattern.
...
- Improved reindex process for the .portal9 index when upgrading from a 2.x-5.x version.
...
- Preventing duplicate APIs from feeding the portal9-monitoring index.
